...
"""
    ...
    for event_idx, event in enumerate(timeline_events):
        ...
        if 'loop' in block_type:
            highlight_color = "#00D9FF"  # Bright Cyan for loops (eye-catching, modern)
        elif 'if' in block_type or 'else' in block_type:
            highlight_color = "#00FF88"  # Emerald Green for conditionals (fresh, vibrant)
        elif 'function' in block_type or 'method' in block_type:
            highlight_color = "#FF6B9D"  # Coral Pink for functions (warm, professional)
        elif 'class' in block_type:
            highlight_color = "#A78BFA"  # Soft Purple for classes (elegant)
        else:
            highlight_color = "#FFA500"  # Bright Orange for other blocks (energetic, not brown!)
...
'''
            ...
            overview_animation = overview_animation_code  # New: animation code
